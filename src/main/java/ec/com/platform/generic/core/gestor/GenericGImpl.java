...
import ec.com.platform.administracion.core.exception.AdministracionException;
import ec.com.platform.administracion.core.gestor.AdministracionGImpl;
...
import ec.com.platform.aspect.annotation.UniqueIndex;
import ec.com.platform.aspect.annotation.UniqueIndexes;
import ec.com.platform.fwk.crud.Crud;
...
//	}
	...
	public void sendMail(String subject, String msg, String from, String ... to){
		...
		if(from==null){
			from = "noreply@platform.com.ec";
		}
		msg = msg + "\r\n\r\n\r\nPlatform: Este correo ha sido generado automaticamente, no es necesario que conteste";
