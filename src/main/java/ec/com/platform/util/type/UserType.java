...
/**
 * This interface should be implemented by user-defined "types". A "type" class
 * is <em>not</em> the actual property type - it is a class that knows how to
 * serialize instances of another class to and from JDBC.<br> <br> This
 * interface <ul> <li>abstracts user code from future changes to the
 * <tt>Type</tt> interface,</li> <li>simplifies the implementation of custom
 * types and</li> <li>hides certain "internal" interfaces from user code.</li>
 * </ul> <br> Implementors must be immutable and must declare a public default
 * constructor.<br> <br> The actual class mapped by a <tt>UserType</tt> may be
 * just about anything.<br> <br> <tt>CompositeUserType</tt> provides an extended
 * version of this interface that is useful for more complex cases.<br> <br>
 * Alternatively, custom types could implement <tt>Type</tt> directly or extend
 * one of the abstract classes in <tt>org.hibernate.type</tt>. This approach
 * risks future incompatible changes to classes or interfaces in that package.
 *
...
public interface UserType {
     ...
     * @throws SQLException
     */
    public Object nullSafeGet(ResultSet rs, String[] names, Object owner) throws Exception, SQLException;
     ...
     * @throws SQLException
     */
    public void nullSafeSet(PreparedStatement st, Object value, int index) throws Exception, SQLException;
     ...
     * @throws Exception
     */
    public Object assemble(Serializable cached, Object owner) throws Exception;
     ...
     */
    public Object replace(Object original, Object target, Object owner) throws Exception;
}
