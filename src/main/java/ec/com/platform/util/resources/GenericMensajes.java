...
/**
 * <p>Permite obtener claves y valores del archivo de recursos del proyecto</p>
 * 
...
public class GenericMensajes {
	 ...
	 */
	private  static final String BUNDLE_NAME = Constantes.DOMAIN_NAME+".util.resources.generic";
