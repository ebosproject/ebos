...
import ec.com.ebos.appl.core.process.ApplPImpl;
 ...
 * 
 */
public abstract class CorePImpl<X, E extends Exception> extends TransactionProxyFactoryBean implements CoreP, Serializable, JsfMessage{
...
//
	...
	private String buildMessage(String key, Object... args) {
		...
		} else if (this instanceof ApplPImpl){
			message = ApplMensajes.getString(key, args);
