...
public class Persona extends Application<Persona>{
    ...
    public enum TipoIdentificacion implements StringValuedEnum<TipoIdentificacion> {
        ...
        public static final String TYPE = Constantes.DOMAIN_NAME+".appl.model.Persona$TipoIdentificacion$Type";
    ...
    public enum TipoPersona implements StringValuedEnum<TipoPersona> {
        ...
        public static final String TYPE = Constantes.DOMAIN_NAME+".appl.model.Persona$TipoPersona$Type";
