package ec.com.ebos.appl.spring.config;
...
@EnableCaching
@ComponentScan({"ec.com.ebos.appl",
	"ec.com.ebos.aspect", 
...
public class ApplConfig {
	...
	public PropertyPlaceholderConfigurer propertyPlaceholderConfigurer(){
		...
		ppc.setLocation(new ClassPathResource("ec/com/ebos/appl/resources/applconfig.properties"));
