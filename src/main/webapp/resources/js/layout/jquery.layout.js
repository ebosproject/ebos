...
,	panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
	...
	,	tips: {
		...
		,	Pin:				"Pin"
		,	Unpin:				"Un-Pin"
		,	noRoomToOpen:		"No hay suficiente espacio para mostrar este panel."	//default:Not enough room to show this panel. alert if user tries to open a pane that cannot
		,	minSizeWarning:		"Panel ha alcanzado su tamaño minimo"	//default:Panel has reached its minimum size displays in browser statusbar
		,	maxSizeWarning:		"Panel ha alcanzado su tamaño maximo"	//default:Panel has reached its maximum size ditto
		}
	//	HOT-KEYS & MISC
