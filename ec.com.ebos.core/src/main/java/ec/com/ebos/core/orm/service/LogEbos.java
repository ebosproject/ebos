 ...
 *
 */
public class LogEbos implements Serializable{
	 ...
	 * @param pAccion
	 */
	public LogEbos(String pSrc, String pEntity, String pAccion) {
		src = pSrc;
		entity = pEntity;
		accion = pAccion;
		fecha = new Date();
	 ...
	 * @param pAccion
	 */
	public LogEbos(String pSrc, String pUsuario, String pEntity, String pAccion) {
		fecha = new Date();
		src = pSrc;
		usuario = pUsuario;
		entity = pEntity;
