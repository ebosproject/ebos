package ec.com.ebos.core.orm.service.interceptor;

import ec.com.ebos.core.orm.service.LogEbos;
import ec.com.ebos.core.orm.service.LogSvc;
...
public class LogCrudInterceptor implements MethodInterceptor {
	...
	public void writeToLog(Object pObj, String pAccion) {
		...
		LogEbos logFwkSat = new LogEbos(LogSvc.LOG_CRUD, entidad ,pAccion);
		logSvc.writeToLog(logFwkSat);
		
	}
	
	public void writeToLogBulk(String pStr) {
		LogEbos logFwkSat = new LogEbos(LogSvc.LOG_CRUD, pStr ,"Actualizacion-Bloque");
		logSvc.writeToLog(logFwkSat);	
	}
